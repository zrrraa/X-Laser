...
lv_obj_set_width( ui_Colorwheel1, 70);
lv_obj_set_height( ui_Colorwheel1, 70);
lv_obj_set_x( ui_Colorwheel1, 97 );
lv_obj_set_y( ui_Colorwheel1, -59 );
lv_obj_set_align( ui_Colorwheel1, LV_ALIGN_CENTER );

ui_Button9 = lv_btn_create(ui_Screen4);
lv_obj_set_width( ui_Button9, 73);
lv_obj_set_height( ui_Button9, 27);
lv_obj_set_x( ui_Button9, -113 );
lv_obj_set_y( ui_Button9, 98 );
